...
{
$str=$invoice->getString();

$str1=str_replace(array("Page {PAGENO} of {nb}","\/Supported\/phpcode\/AWKE-small-logo.png","/l:"),array("","http://www.awke.co.uk/AWKE-small-logo.png","http://www.awke.co.uk/AWKE-small-logo.png\">"),$str);
$str=$str1;

//$str=htmlspecialchars($str);

print <<<END
<h2><a href="$_SERVER[PHP_SELF]?ID=$id&PDF=1">Click here to view the pdf version</a></h2><br>
...
$sql="SELECT * from adminInfo.invoices WHERE uniqueidinvoice='$id'";
$result=gosql($sql,0);
...
END;
$invoice=sprintf("<table width=\"100%%\" ><tr><td width=\"33%%\"><img src=\"
../awke-logo.jpg\" width=\"248\" height=\"54\"> </td>");


if($row[paid]==1)
{
$mnthd=explode(" ",$row[lastupdated]);
$mnthd1=$mnthd[0];
$PAID="<font size=\"+2\"><b>PAID</font></b> on $mnthd1";
}
else
{
$PAID="";
...
$invoice=$invoice. sprintf("<td><center><h1>INVOICE$VOID</h1></center></td><td width=\"33%%\">&nbsp;$PAID</td></tr></table>");
