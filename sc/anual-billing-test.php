...
$sql="insert into invoicestest set customer='$customerid',invoicedate='$date',createdate='$today'";
gosql($sql,0);
...
$sql="UPDATE invoicestest set string='$string',variable='$variable',total='$total',numbitems='$numbitems',custref='$crn',uniqueidinvoice='$uniqid' WHERE idinvoices='$irn'";
...
if($returned[1]==0)
{
$sql="UPDATE invoicestest set paid='1' WHERE idinvoices='$returned[2]'";
gosql($sql);
}
