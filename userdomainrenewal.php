...
if(isset($_POST[renew]) && $rows[renew]==0)
{
$to="admin@awke.co.uk";
...
try
{
//  $wantedemail->AddAddress("support@ukhosts.com", "UKHosts Support");
  $wantedemail->SetFrom('admin@awke.co.uk', 'AWKE Admin (Script)');
...
// $wantedemail->AddReplyTo('support@awke.co.uk', 'AWKE Accounts');
 $wantedemail->Subject="NOT EMAILED TO UKHOSTS Please renew $domain";
$wantedemail->Body="Hi could you please renew $domain.\nThanks\n\nAWKE Admin\n";
$wantedemail->Send();
}
...
$invoice->setemailsubject("AWKE Invoice @IRN@ for domain renewal of $domain");
$invoice->setemailbody("@FNAME@ @LNAME@,\n\nHi your AWKE invoice @IRN@ for renewal of $domain is attached or else is available to view on the web at https://secure.awke.co.uk/admin/invoicedisplay.php?ID=@UNIQID@\n\nThanks\n\nAWKE Accounts\n");
...
//$wantedemail->ClearReplyTos();
// $wantedemail->AddReplyTo('support@awke.co.uk', 'AWKE Accounts');
 $wantedemail->Subject="DO NOT RENEW $domain";
$wantedemail->Body="Hi please DO NOT RENEW $domain.\nThanks\n\nAWKE Admin\n";
$wantedemail->Send();
}
 catch (phpmailerException $e) {
  echo $e->errorMessage(); //Pretty error messages from PHPMailer
